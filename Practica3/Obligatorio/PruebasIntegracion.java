...
public class PruebasIntegracion {
	...
	public static void main(String[] args) {
		...
		System.out.println("Añadimos otra sala para usarla posteriormente: " + (s2 != null));
		...
		System.out.println("Añadimos otra sesión en misma sala y distinta fecha: " + 
				(se2 != null));
		System.out.println("Añadimos otra sesión en misma fecha y distinta sala: " + 
